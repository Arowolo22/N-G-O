...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save user's full name to Firebase Auth
            ...
            >
              ...
              <form className="mt-6 grid gap-3" onSubmit={handleSubmit}>
                <div className="grid gap-3 sm:grid-cols-2">
                  <label className="grid gap-1">
                    ...
                    <input
                      ...
                      className="h-11 rounded-2xl bg-white/80 px-4 text-sm ring-1 ring-black/10 text-black focus:outline-none focus:ring-2 focus:ring-sky-400/50"
                      value={firstName}
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="mt-2 h-12 rounded-2xl bg-black text-white font-extrabold shadow-lg hover:brightness-105 transition disabled:opacity-60 disabled:cursor-not-allowed"
                >
