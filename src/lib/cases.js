...
**Current Situation:**
Emeka has started the 6-month DOTS regimen. He is currently in the *Intensive Phase*, taking daily medication under supervision. However, the side effects and his inability to work mean his family is struggling to eat.

**Medical Needs:**
- Daily DOTS medication monitoring.
- Monthly liver function tests to check for drug toxicity.
- Nutritional support (high-protein diet) to tolerate the strong antibiotics.
...
Without adequate protein, Fatima's body cannot repair the tissue damage caused by the bacteria. She has already lost 8kg since her diagnosis and suffering from severe nausea.

**The Intervention:**
We are providing Fatima with a weekly nutrient pack containing:
- Eggs and Milk
- Beans and Soy
- Multivitamins

This simple intervention significantly boosts cure rates and helps patients like Fatima regain their strength and independence faster.`,
    problem:
...
**Our Strategy:**
Arowolo Health Foundation is deploying a Mobile Screening Unit to Makoko for a 3-day health drive. 
- **Step 1:** Community volunteers raise awareness and identify symptomatic individuals.
- **Step 2:** On-site digital Chest X-rays using AI-assisted detection.
- **Step 3:** Sputum samples collected for GeneXpert testing.
- **Step 4:** Immediate enrollment into treatment for positive cases.

Your support funds the logistics, the medical team, and the testing kits needed to screen over 500 people in just one weekend.`,
    problem:
...
**The Challenge:**
Children need child-friendly, dispersible tb medicines that taste better and are easier to swallow than bitter adult pills. They also require closer monitoring to prevent developmental delays.

**Your Impact:**
Donating to this fund ensures Chinedu gets:
1. Pediatric-formulated anti-TB drugs.
2. Nutritional supplements to aid growth catch-up.
3. Toys and educational materials to keep him engaged during long hospital visits.

Saving a child from TB gives them their entire future back.`,
    problem:
...
**The Solution:**
We are raising funds to rent a temporary self-contained room for Grace for 2 months. This "Isolation Support" provides:
- A safe, ventilated space for her to recover without guilt or fear.
- Daily food delivery so she doesn't need to cook or go out.
- Hygiene kits (masks, disinfectants) to maintain a sterile environment.

Helping Grace isolate is not just charitable; it is a public health necessity to stop the spread of DR-TB.`,
    problem:
